    ...
    return (
        <>
            ...
            <main className='w-full h-5/6 flex flex-col md:flex-row justify-center items-center'>
                <nav className='w-10/12 md:w-1/12 h-1/6 md:h-3/4 flex md:flex-col items-center justify-around p-10 border-2 border-gray-800 rounded-xl '>
                ...
                <section className='w-10/12 md:w-4/6 h-4/6 md:h-3/4 flex flex-col gap-10 p-10 border-2 border-gray-800 rounded-xl '>
                    {children}
                </section>
            </main>
        </>
